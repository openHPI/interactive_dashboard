...
var CoursesComponent = (function () {
    ...
    CoursesComponent.prototype.update = function () {
        ...
        this.courseService.getCourses().subscribe(function (courses) {
            ...
            _this.courses = _this.courses.filter(function (course) { return (course.attributes.status === 'announced' || course.attributes.status === 'active'); });
...
var WorldMapComponent = (function () {
    ...
    WorldMapComponent.prototype.callApisAndSetMarkers = function (startDate, endDate) {
        var _this = this;
        this.dataService.getWorldPositions(startDate, endDate).subscribe(function (plattformAndPositions) {
            var platforms = plattformAndPositions[0];
            console.log(platforms); //do whatever you like and remove this line please
            var geoArrays = plattformAndPositions.slice(1, plattformAndPositions.length);
            _this.userPositions = [];
            for (var i = platforms.length - 1; i >= 0; i--) {
                _this.pushPositions(geoArrays[i], platforms[i].mapMarkerUrl);
            }
            _this.dataService.updateCompleted();
        });
    };
    WorldMapComponent.prototype.pushPositions = function (jsonArray, mapMarkerUrl) {
    ...
    WorldMapComponent.prototype.log = function (event, str) {
...
// module
exports.push([module.i, ".carousel {\r\n\tmin-height: 900px;\r\n\tmargin-top: 100px;\r\n}\r\n\r\n\r\n\r\na.arrow_prev {\r\n  display:block;\r\n  width:70px;\r\n  height:100px;\r\n  background:url(\"http://www.de-online.ru/icon/left_arrow.png\") top left no-repeat !important;\r\n  overflow: hidden;\r\n  position: absolute;\r\n    text-indent: -9999px;\r\n    margin: 450px 20px 20px -100px;\r\n}\r\n\r\n\r\n\r\n\r\na.arrow_next {\r\n  display:block;\r\n  width:70px;\r\n  height:100px;\r\n  background:url(\"http://www.de-online.ru/icon/right_arrow.png\") top left no-repeat !important;\r\n  overflow: hidden;\r\n  position: absolute;\r\n    text-indent: -9999px;\r\n    margin-left: 1300px;\r\n    margin-top: 450px;\r\n}\r\n", ""]);
...
module.exports = "<div class=\"row\">\r\n\t<div *ngFor=\"let promo of promoNumbers\" class=\"col s3\">\r\n\t\t<app-promo-numbers-component [promo]=promo></app-promo-numbers-component>\r\n\t</div>\r\n</div>\t"
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_assets_reviews_reviews__ = __webpack_require__(190);
